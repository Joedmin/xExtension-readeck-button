...
return array(
  'readeckButton' => array(
    'configure' => array(
      ...
      <li><b>Inteligentní</b> (výchozí) - přepíná mezi starým a novým chováním na základě toho, zda je nastavena autentizace kanálu</li>
      <li><b>Odkaz</b> (staré chování) - odešle pouze odkaz na článek a nechá Readeck načíst obsah</li>
      <li><b>Obsah</b> (nové chování) - přímo odešle obsah ze zdroje do Readeck. Užitečné, když jsou články za paywallem, ale ve zdroji jsou kompletní.</li><ul>'
    ),
    'notifications' => array(
